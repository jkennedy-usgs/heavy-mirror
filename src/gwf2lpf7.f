...
C     ------------------------------------------------------------------
     ...
     1                      BUFF,BOTM,LBOTM,IOUT
      ...
      CHARACTER*16 TEXT
      doubleprecision STOIN,STOUT,SSTRG,HSING,SIN,SOUT,STRG
C
      DATA TEXT /'         STORAGE'/
C     ------------------------------------------------------------------
C
...
C     ------------------------------------------------------------------
     ...
     1                      ICHFLG
      ...
      CHARACTER*16 TEXT
      doubleprecision HD,CHIN,CHOUT,XX1,XX2,XX3,XX4,XX5,XX6,HDIFF,TMP
      doubleprecision CIN,COUT,CHCH1,CHCH2,CHCH3,CHCH4,CHCH5,CHCH6
      doubleprecision X1,X2,X3,X4,X5,X6
...
C3C-----HNEW=HDRY, SATURATED THICKNESS=0.0, AND IBOUND=0.
  ...
  152          FORMAT(1X,'LAYER=',I3,' ROW=',I5,' COLUMN=',I5,
     1    ' ITERATION=',I3,' TIME STEP=',I6,' STRESS PERIOD=',I4) ! gsf
               CALL USTOP(' ')
            END IF
            IBOUND(J,I,K)=0
         END IF
...
C2------INDICATES THAT A PARTIAL LINE SHOULD BE PRINTED.
   ...
   17    FORMAT(1X,/1X,'CELL CONVERSIONS FOR ITER.=',I3,'  LAYER=',
     1       I3,'  STEP=',I6,'  PERIOD=',I4,'   (ROW,COL)') !gsf
         IHDCNV=1
...
C
      doubleprecision BBOT,TTOP,HHD,BOVK1,BOVK2,CBBOVK,B
C     ------------------------------------------------------------------
C
      IF(K.EQ.NLAY) RETURN
      ZERO=0.
